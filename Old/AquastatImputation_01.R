...
l01 <- merge.list(l1_values, l2_imputed_values, by = c("geographicAreaM49", "timePointYears"))
l02 <- merge.list(l5_imputed_values, l5_imputed_values, by = c("geographicAreaM49", "timePointYears"))
l_final <- merge.list(l01, l02)
