...
2. **aquastat_questionnaire**. An SWS dataset fed with new data (though import) to be incorporated in the AQUASTAT database. This dataset feeds, along with the aquastat_external and the aquastat_update datasets, the `faoswsAquastatUpdate` module. More information is found in the chapter \@ref(AquastatQuestionnaire).
