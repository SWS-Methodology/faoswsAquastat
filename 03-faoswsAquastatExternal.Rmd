...
```{r  figExternal, echo=FALSE, out.width="65%", fig.align="center", fig.show='hold', fig.cap='Ideal Workflow of the faoswsAquastatExternal module'}
knitr::include_graphics("images/faoswsAquastatExetrnal.png")
